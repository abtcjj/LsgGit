...
<div class="bigbox">
  ...
  <div class="bigboxbody">
	...
	if(!empty($_SESSION["province"]))
		$psql.=" and b.provinceid='".getdistrictid($_SESSION['province'])."'";
	if(!empty($_SESSION["city"]))
		$psql.=" and b.cityid='".getdistrictid($_SESSION['city'])."'";
	if(!empty($_SESSION["area"]))
		$psql.=" and b.areaid='".getdistrictid($_SESSION['area'])."'";
	...
	$sql="SELECT  a.*,b.company FROM ".PRO." a  left join ".SHOP." b on a.userid=b.userid
	...
	?>
        <tr id="plist_<?php echo $re[$i]['id']; ?>" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this,'odd')">
		  ...
		  ?></td>
          <td><b><?php echo $config['money'].$re[$i]["price"]; ?></b><br /><a href="<?php echo $config['weburl'];?>/?m=product&s=detail&id=<?php echo $re[$i]['id'];?>" target="_blank"><?php echo csubstr($re[$i]["pname"],0,60);?></a></td>
          <td align="left"><?php
        ...
        <tr>
          ...
          <input type="hidden" name="statu" value="<?php echo $_GET['statu']; ?>" />
