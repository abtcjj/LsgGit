...
class share
{
	...
	function GetShareGoodsList()
	{
		...
		$sql="select a.id,a.pid,a.commentcount,b.image,b.pname,b.price,b.collectnum,c.sell_amount from ".SPRO." a left join ".SPROINFO." b on a.pid = b.pid left join ".PRO." c on a.pid=c.id where a.uid=$buid $sql order by a.addtime desc";
