<?php /* Smarty version 2.6.20, created on 2015-04-09 17:13:45
...
"><?php echo $this->_tpl_vars['list']['pname']; ?>
 ...
 <?php echo $this->_tpl_vars['list']['price']; ?>
                ...
                <td><?php echo $this->_tpl_vars['list']['rank']; ?>
</td>
                <td><?php $this->assign('num', $this->_tpl_vars['list']['statu']); ?><?php echo $this->_tpl_vars['status'][$this->_tpl_vars['num']]; ?>
</td>
                <td><?php echo $this->_tpl_vars['list']['read_nums']; ?>
</td>
...
条记录</div>
    ...
    <div id="mdly" class="hidden">
        ...
        <p>
            ...
            <span>|</span>
            <a id="button" key="down" href="javascript:;"><b>违规下架</b></a>
            <span>|</span>
